...
import {ALL_CATEGORIES, AllCategoriesData, REMOVE_CATEGORY, CategoryData} from '../../graphql/CategoryGQL'
  ...
  return (
    <PageLayout loading={loading} refetch={refetch}>
      ...
      <Overlay isVisible={isDeleteModalVisible} onBackdropPress={handleBackdropPress} height='auto'>
        <>
          <Text style={styles.deleteWarning}>Are you sure you want to delete this category?</Text>
